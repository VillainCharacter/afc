                                ...
                                <div class="panel-body">
                                    <form action="updateproduct" method="post">
                                        ...
                                        <div class="modal-body">                    
                                            ...
                                            <div class="form-group">
                                                <label>Chip</label>
                                                <input type="text" class="form-control" name="chip" value="${requestScope.product.chip}" />
                                            </div>
                                            <div class="form-group">
                                                <label>RAM</label>
                                                <input type="text" class="form-control" name="ram" value="${requestScope.product.ram}" />
                                            </div>
                                            <div class="form-group">
                                                <label>ROM</label>
                                                <input type="text" class="form-control" name="rom" value="${requestScope.product.rom}" />
                                            </div>
                                            <div class="form-group">
                                                <label>GPU</label>
                                                <input type="text" class="form-control" name="gpu" value="${requestScope.product.gpu}" />
                                            </div>
                                            <div class="form-group">
